...
public class myfirstjavaprogram {
	...
	/* sample test programs to understand basics of print statement */
		...
		public static void main(String[] args) throws FileNotFoundException {
			...
			//printf statement
			System.out.printf("%s is an engineer: empid is %d: status is %b: salary is %f","Varun",123456,true,1000000.09);
			System.out.println();
			System.out.printf("%s is an engineer: empid is %d: status is %b: salary is %f","priya",987654,true,2000000.09);
			System.out.println();
			System.out.println("==================================================================");
